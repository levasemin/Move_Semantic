...
template <class T>
void Tracker::print_operation(const SuperType<T> &first_object, const SuperType<T> &second_object, SuperType<T> &result, std::string operation, 
                        const std::string &color = "black", const std::string &style = "")
{
...
template<class T>
int Tracker::print_operation(SuperType<T> &first_object, std::string operation, const std::string &color = "black", const std::string &style = "")
{
...
int Tracker::print_oper(const std::string &operation, const std::string &color = "black", const std::string &style = "")
{
    ++id;
