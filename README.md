...
~~~
При отсутствии этой оптимизации, во время работы кода будет создан дополнительный временный объект, который расположен в области определения object_1, в него будет скопирован результат операцииobject_2 + object_3, после этого он будет скопирован в объект object_1. Оптимизация приводит к отсутствию этого временного объекта. 
