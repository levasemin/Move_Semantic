...
![](diagrams/simple_swap.png)
О чудо! Мы снова волшебники и все работает так, как мы и хотели. Move, кажется, грубой силой, ее инструмент дубинка и под её влиянием любой станет rvalue. Однако остается вопрос, что такое функция forward? Попробуем применить.
