...
# Среда экспериментов 
 &nbsp;&nbsp;&nbsp;В качестве подопытного выступает класс SuperType\<T\>, который по существу является оберткой над любым типом T. В качестве инструмента для отображения выступает класс Tracker и библиотека Graphviz. В ходе экспериментов подопытному предстоит в различных модификациях выполнять поставленные задачи.
...
<br> 
    <img src="diagrams/graph_nice.png" alt="Фотография 2" width="620" height="500" align="right"/>
